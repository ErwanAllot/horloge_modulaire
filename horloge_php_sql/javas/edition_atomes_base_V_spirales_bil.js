...
function impression_d_un_atome(nombre, angle,cf){
...
function couleur_de_l_atome(cf){
    // (nombre % 2 == 0)? couleur = 'white' : couleur = 'grey';
    //  couleur = 'black'
     couleur = 'red';

    //  if(cf%3==1) {couleur = 'purple';}
    //  if(cf%3==2) {couleur = 'white';}
        if(cf%4==1) {couleur = 'blue';}
    if(cf%4==3) {couleur = 'green';}
}
