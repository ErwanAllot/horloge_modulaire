...
function factorisation_du_cycle(){
    ...
    if($cycle == 0) $factorisation_du_nombre = '0^1';
    if($cycle == 1) $factorisation_du_nombre = '1^1';
    if($cycle == 2) $factorisation_du_nombre = '2^1';

    if($cycle > 2){
        $racine_carree_du_nombre = floor(sqrt($cycle));
        $nombre_triture = $cycle;
        $diviseur = 2;
        $fin_de_la_factorisation = 'non';
        ...
        if ($factorisation_du_nombre == ''){$factorisation_du_nombre = $cycle . '^1';}
    }
}
